...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> implements Filterable {
    ...
    public SearchAdapter(ClassCheck classCheck,ClassModel classModel){
        searchText = "";

        this.activity = classCheck;
    ...
    public void onBindViewHolder(final SearchAdapter.ViewHolder holder, int position) {
        ...
        holder.no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                classModel.getStudents()[finalIndex].checkClass(classModel.getCurrentWeek(),0);
        ...
        holder.late.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                classModel.getStudents()[finalIndex].checkClass(classModel.getCurrentWeek(),2);
        ...
        holder.yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                classModel.getStudents()[finalIndex].checkClass(classModel.getCurrentWeek(),1);
                holder.setView(activity,1);
            }
        });

        holder.setView(activity,s.getClassChecked(classModel.getCurrentWeek()));
